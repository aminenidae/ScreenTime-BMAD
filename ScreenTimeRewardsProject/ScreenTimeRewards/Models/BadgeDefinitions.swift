...
extension BadgeDefinition {
    static let starterBadges: [BadgeDefinition] = [
        ...
        BadgeDefinition(
            ...
            description: String(localized: "Complete 100 hours of learning"),
        ...
        BadgeDefinition(
            ...
            description: String(localized: "Earn 10,000 learning points"),
        ...
        BadgeDefinition(
            ...
            description: String(localized: "Complete 10 challenges"),
            icon: "rosette",
